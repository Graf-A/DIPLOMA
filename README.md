...
### Документация:
 1. План автоматизации (файл [Plan.md](https://github.com/Graf-A/DIPLOMA/blob/master/Plan.md))

 1. Отчет о проведённом тестировании (файл [Report.md](https://github.com/Graf-A/DIPLOMA/blob/master/Report.md))
 
 1. Отчёт о проведённой автоматизации (файл [Summary.md](https://github.com/Graf-A/DIPLOMA/blob/master/Summary.md))
...
```
git clone https://github.com/Graf-A/DIPLOMA.git
```

*Примечание:*  
*1. файлы для запуска приложения, контейнера и симулятора банковских сервисов находятся в папке [/artifacts](https://github.com/Graf-A/DIPLOMA/tree/master/artifacts);*  
*2. на проекте поддерживается две СУБД (MySQL, PostgreSQL), для запуска приложения на СУБД MySQL используется файл [docker-compose-mysql.yml](https://github.com/Graf-A/DIPLOMA/blob/master/artifacts/docker-compose-mysql.yml), на PostgreSQL-[docker-compose-postgresql.yml](https://github.com/Graf-A/DIPLOMA/blob/master/artifacts/docker-compose-postgresql.yml);*  
*3. для реализации проекта на ОС Windows 10 (и выше), либо Linux/MacOS в файле [application.properties](https://github.com/Graf-A/DIPLOMA/blob/master/artifacts/application.properties) необходимо указывать хост localhost, на ОС Windows 7 или  Windows 8 необходимо указывать хост 192.168.99.100, установив Docker Toolbox;*  
*4. СУБД MySQL работает на порту 3306, PostgreSQL на порту 5432*

2. Открыть склонированный проект с помощью IntelliJ IDEA
3. Открыть файл [application.properties](https://github.com/Graf-A/DIPLOMA/blob/master/artifacts/application.properties) и прописать в строке 3:
...
```
4. Запустить приложение [aqa-shop.jar](https://github.com/Graf-A/DIPLOMA/blob/master/artifacts/aqa-shop.jar) командой:
```
